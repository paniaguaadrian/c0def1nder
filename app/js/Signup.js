...
class Signup {
  constructor() {
    ...
    this.languageInput = document.querySelector("#language");
  ...
  saveData = (event) => {
    ...
    const newUser = new User(name, language, email, password);
  ...
  showSuccessMessage = () => {
    ...
    successMessageP.innerHTML = "You're account is ready to rock!";
